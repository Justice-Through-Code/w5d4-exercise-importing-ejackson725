...
display_playlist(my_playlist_helpers)
...
my_song = {"artist": "Ma$e", "title": "Welcome Back"}
add_song(my_playlist_helpers, my_song)
...
my_song2 = {"artist": "Kanye", "title": "Jesus Walks"}
my_song3 = {"artist": "Pop Smoke", "title": "Welcome to the Party"}
add_song(my_playlist_helpers, my_song2)
add_song(my_playlist_helpers, my_song3)
...
playlist_length = get_playlist_length(my_playlist_helpers)
...
play_track(my_playlist_helpers, 1)
play_track(my_playlist_helpers, 2)
play_track(my_playlist_helpers, 3)